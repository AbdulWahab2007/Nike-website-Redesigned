  ...
  return (
    <>
      <div
        ...
        className="container flex w-full h-[660px] bg-[url('/public/background.png')] bg-cover bg-center mt-3"
      >
        <div className="left w-1/2 mx-1 h-full  flex flex-col">
          ...
          <div className="flex ml-16 mt-4 w-[199px]">
            <div className="relative group">
              <button className="relative inline-block p-px font-semibold leading-6 text-black bg-gray-800 cursor-pointer rounded-xl transition-transform duration-300 ease-in-out hover:scale-105 active:scale-95">
