...
export default function Main() {
  const logoClass = "my-3 hover:cursor-pointer";
  return (
    <>
      <div
        style={{
      ...
      >
        <div className="left w-[45%] mx-1 h-full  flex flex-col">
          ...
          <div className="flex ml-16 mt-28 items-center gap-4">
            ...
            <div className="social-button">
              <button className="relative w-10 h-10 rounded-full group">
                <div className="floater w-full h-full absolute top-0 left-0 bg-white rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                <div className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-black rounded-full">
                  ...
                  >
                    <path
                      ...
                      className="group-hover:fill-white fill-[#171543] duration-300"
                    ></path>
                  </svg>
                </div>
              </button>
