...
export default function Navbar() {
  const anchorClass =
    "lg:m-5 m-[1.5vw] lg:text-xl text-[2.7vw] font-subHeads font-medium hover:bg-gradient-to-r from-fuchsia-700 to-purple-700 hover:text-transparent hover:bg-clip-text";
  const iconClass =
    "material-symbols-outlined lg:mx-2 mx-[-3px] scale-50 md:scale-75 lg:scale-100 hover:bg-gradient-to-r from-fuchsia-700 to-purple-700 hover:text-transparent hover:bg-clip-text hover:font-bold hover:font-semibold";
  return (
    <>
      <div className=" lg:h-16 h-[12vw] w-full fixed top-0 z-20 flex shadow-sm shadow-black bg-white ">
